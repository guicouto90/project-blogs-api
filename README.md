...
Esse foi um projeto da Trybe feito, onde foi utilizado conceitos ORM(sequelize) com arquitetura MSC.

Basta clonar o repositório e instalar as dependencias - npm install.
